...
export default function ConfirmationCertificatePage() {
  ...
  const parish = confirmation.parish ?? baptism?.parishName ?? '—';
          ...
          <article className={`rounded-lg border-2 border-gray-200 print:border-sancta-maroon print:p-12 ${isEmbed ? 'p-4' : 'p-8'}`} style={isEmbed ? { minHeight: 'auto' } : { minHeight: '50vh' }}>
            ...
            <div className="mt-8 space-y-4">
              <p className="text-gray-700">
                ...
                <strong>{formatDisplayDate(confirmation.confirmationDate)}</strong> at {parish}.
              </p>
              <p className="text-gray-600 text-sm">
                Officiating bishop: {confirmation.officiatingBishop}
              </p>
            </div>
